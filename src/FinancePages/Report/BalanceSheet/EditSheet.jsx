...
function EditSheet({ editingSheet, setEditingSheet }) {
  ...
  const inputHandler = (masterCode, groupCode, value) => {
    console.log(masterCode, groupCode, value);
  ...
  const updateGroup = async (groupCode, values) => {
    let finalObj = {
      subgroups: values.map((row) => row.value),
                ...
                <Row gutter={8} style={{ margin: 10 }}>
                  ...
                  <Col span={18}>
                    <MyAsyncSelect
                      ...
                      onChange={(value) =>
                        inputHandler(row.code, group.key, value)
                      }
                  ...
                  <Col span={2}>
                    <CommonIcons
                      ...
                      onClick={() => updateGroup(group.key, group.children)}
                      action="checkButton"
                    />
                  </Col>
                </Row>
