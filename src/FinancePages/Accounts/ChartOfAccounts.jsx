  ...
  const getChart = async () => {
    ...
    if (data) {
      ...
      let summaryData = [
        ...
        { title: "Closing", description: data.summary[0].closing },
        { title: "Opening", description: data.summary[0].opening },
        { title: "Total Credit", description: data.summary[0].total_credit },
        { title: "Total Debit", description: data.summary[0].total_debit },
      ];
