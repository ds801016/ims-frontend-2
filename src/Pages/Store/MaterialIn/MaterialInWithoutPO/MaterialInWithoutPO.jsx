...
export default function MaterialInWithoutPO() {
  ...
  const vendorDetailsOptions = [
    ...
    // { text: "Sort In", value: "s01" },
    // { text: "Rej In", value: "r01" },
    { text: "Product Return", value: "p01" },
  ];
  const addRow = () => {
  ...
  const validataData = () => {
    ...
    console.log(form.getFieldValue("vendorType"));
    console.log(form.getFieldValue("ewaybill").length);
    if (validation == true) {
    ...
    axiosResponseFunction(async () => {
      if (invoices?.length) {
        ...
        if (fileData.code != 200) {
          ...
          final = {
            ...final,
            ...showSubmitConfirm.componentData,
            ...venDetails,
          };
          setSubmitLoading(true);
        ...
        final = { ...final, ...showSubmitConfirm.componentData, ...venDetails };
        setSubmitLoading(true);
