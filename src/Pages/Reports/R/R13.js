...
const R13 = () => {
  document.title = "Custome MIN Report";
  ...
  const columns = [
    ...
    { field: "COMPONENT", headerName: "Component", width: 380 },
    ...
    { field: "VENDOR", headerName: "Vendor Name", width: 220 },
    { field: "PONUMBER", headerName: "Po No", width: 140 },
    { field: "INVOIVENUMBER", headerName: "Inv Doc", width: 150 },
    { field: "TRANSACTION", headerName: "Transaction Code", width: 150 },
    { field: "ISSUEBY", headerName: "Added By", width: 140 },
    ...
    <div style={{ height: "100vh" }}>
      <Row gutter={16} style={{ margin: "10px" }}>
        ...
        <Col span={2} className="gutter-row">
          <Button type="primary" onClick={fetch} block>
            Fetch
          </Button>
        </Col>
