...
const R7 = () => {
  document.title = "PPR Replenishment";
  ...
  const columns = [
    ...
    { field: "part_no", headerName: "PART NO.", width: 120 },
    { field: "part_name", headerName: "COMPONENT", width: 350 },
    // { field: "category", headerName: "Category", width: 100 },
    {
      ...
      type: "status",
      renderCell: ({ row }) => (
        <span dangerouslySetInnerHTML={{ __html: row.bomstatus }} />
      ),
    },
    ...
    { field: "replenish", headerName: "REPLENISHMENT", width: 140 },
  ];
