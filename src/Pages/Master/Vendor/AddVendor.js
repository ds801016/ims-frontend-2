...
import { Row, Col, Input, Form, Descriptions, Divider } from "antd";
...
const AddVendor = () => {
  ...
  return (
    <div style={{ height: "90%" }}>
      <Form size="small" layout="vertical" style={{ padding: 20 }}>
        <Row gutter={16}>
          <Col span={4}>
            <Descriptions
              size="small"
      ...
      <NavFooter
        resetFunction={reset}
        submitFunction={addVendorDetail}
        nextLabel="Submit"
        disabled={{ reset: submitLoading }}
