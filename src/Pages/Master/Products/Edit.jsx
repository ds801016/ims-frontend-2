...
const Edit = ({
  ...
  const getDetails = async () => {
    ...
    if (data.code === 200) {
      ...
      obj = {
        ...obj,
        producttype: productType === "sfg" ? "semi" : "default",
      };
    ...
    >
      <Form form={updateProductForm} onFinish={submitHandler} layout="vertical">
        ...
        <Row gutter={8}>
          <Col span={8}>
            {detailsLoading && (
              <Skeleton.Input active loading={detailsLoading} />
            )}
          ...
          <Col span={8}>
            ...
            <Form.Item name="uomid" label="UOM">
              {!detailsLoading && <MySelect options={uomOptions} />}
            </Form.Item>
          </Col>
          <Col span={8}>
            {detailsLoading && (
        ...
        <Row gutter={8}>
          ...
          <Col span={6}>
            ...
            <Form.Item name="producttype" label="Product Type">
              {!detailsLoading && <MySelect options={productTypeOptions} />}
            </Form.Item>
          </Col>
          <Col span={6}>
            {detailsLoading && (
          ...
          <Col span={6}>
            ...
            <Form.Item name="enablestatus_name" label="Enabled">
              {!detailsLoading && <MySelect options={enabledOptions} />}
            </Form.Item>
          </Col>
        </Row>
        ...
        <Row>
          <Col span={24}>
            {detailsLoading && (
              <Skeleton.Input block active loading={detailsLoading} />
            )}
            <Form.Item name="description" label="Description">
              {!detailsLoading && <Input.TextArea rows={4} />}
            </Form.Item>
          </Col>
        </Row>
        ...
        <Row gutter={8}>
          <Col span={8}>
            ...
            <Form.Item name="tax_type_name" label="Tax Type">
              {!detailsLoading && <MySelect options={taxOptions} />}
            </Form.Item>
          </Col>
          <Col span={8}>
            {detailsLoading && (
          ...
          <>
            ...
            <Row gutter={8}>
              <Col span={8}>
                ...
                <Form.Item name="vweight" label="Volumetric Weight">
                  {!detailsLoading && <Input />}
                </Form.Item>
              </Col>
              <Col span={8}>
            ...
            <Row gutter={8}>
              ...
              <Col span={6}>
                ...
                <Form.Item name="batchstock" label="MFG Batch Size">
                  {!detailsLoading && <Input />}
                </Form.Item>
              </Col>
              <Col span={6}>
                ...
                <Form.Item name="loc" label="Default Stock Location">
                  {!detailsLoading && <Input />}
                </Form.Item>
              </Col>
            </Row>
            ...
            <Row gutter={8}>
              <Col span={6}>
                ...
                <Form.Item name="laboutcost" label="Labour Cost">
                  {!detailsLoading && <Input />}
                </Form.Item>
              </Col>
              <Col span={6}>
