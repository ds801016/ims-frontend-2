        ...
        {!skeletonLoading && (
          <Image.PreviewGroup>
            {images.map((image) => (
              ...
              <Col span={12}>
                <Card style={{ height: 280, position: "relative" }} hoverable>
                  <Space direction="vertical" size="middle">
                    ...
                    <Space align="center">
                      ...
                      <Typography.Text>Uploaded By:</Typography.Text>
                      <Typography.Text
                        style={
                          ellipsis
                            ? {
                    ...
                    <Space align="center">
                      <Typography.Text>Uploaded On:</Typography.Text>
                      <Typography.Text
                        style={
                          ellipsis
                            ? {
