...
const Material = () => {
  ...
  const columns = [
    ...
    { field: "c_name", headerName: "Component", width: 350 },
...

    {
      ...
      getActions: ({ row }) => [
        <TableActions
          action="edit"
          onClick={() => setMaterialModal(row.component_key)}
        />,
        <TableActions
          action="view"
          onClick={() =>
  ...
  const column = [
    {
      headerName: (
        <span onClick={addHsnRow}>
          <PlusOutlined style={{ cursor: "pointer", fontSize: "1.0rem" }} />
        </span>
      ),
      width: 70,
      field: "add",
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setMaterial((material) => {
                      return { ...material, partno: e.target.value };
                    })
                  }
                />
              </div>
            ...
            <Col span={12}>
              <div>
                <Input
                  ...
                  onChange={(e) =>
                    setMaterial((material) => {
                      return { ...material, comp: e.target.value };
                    })
                  }
                />
              </div>
